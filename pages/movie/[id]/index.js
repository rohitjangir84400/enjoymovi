    ...
    <>
      <div className="container max-w-4xl mx-auto pt-6">
        ...
        <div className="px-3">
          ...
          <p className="text-gray-600 text-sm mt-4">{movies.overview}</p>
          <p className="mt-5 text-gray-600 text-sm">Genres: <span className="font-bold">{movies.genres.map(genre => genre.name).join(', ')}</span></p>
          <p className="text-gray-600 text-sm">Release Date: <span className="font-bold">{movies.release_date}</span></p>
        </div>
