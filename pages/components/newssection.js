    ...
    return (
        <div className="text-center bg-[#edf5f7] px-10 py-20">
            ...
            <div className="flex flex-wrap">
                    ...
                    <div className="bg-white border">
                        <div>
                            <div className="w-fit mx-auto overflow-visible">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="gray" viewBox="0 0 24 24" stroke-width="1.5" stroke="white" class="w-[150px] h-[150px]">
                ...
                <div className="basis-12/12 md:basis-1/3 p-5">
                    <div className="h-[250px] relative">
                        <Image src={'/images/img-2.jpg'} layout='fill' objectFit="contain" />
                    </div>
                    <div className="bg-white border">
                        <div>
                            <div className="w-fit mx-auto overflow-visible">
